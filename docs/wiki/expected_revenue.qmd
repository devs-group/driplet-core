...
df = pd.DataFrame(data={
  ...
  'costs of development': [1000, 1000, 1500, 2000, 3000, 4000, 5000, 5500],
...
## Revenue Projection (Reduced) {.smaller}
...
df2 = pd.DataFrame(data={
  'time': ['Q1-25', 'Q2-25', 'Q3-25', 'Q4-25', 'Q1-26', 'Q2-26', 'Q3-26', 'Q4-26'],
  'revenue': [0, 400, 800, 1200, 100000, 1000000, 5000000, 5000000],
  'costs (ops, token dist., development)': [1000, 1000, 1500, 2000, 3000, 4000, 5000, 5500],
  'earnings': [0, 400, 800, 1200, 100000, 1000000, 5000000, 5000000]
})
df2.index = df2['time']
df2.index.name = 'time'
